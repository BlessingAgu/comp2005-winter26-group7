...
public class GameBoard implements java.awt.event.ActionListener{
    ...
    JLabel topField, topField2, score;
    JButton rotateButton, helpButton, passButton, confirmMove, turnButton;
    ...
    public GameBoard(){
        ...
        turnButton.setPreferredSize(new Dimension(100,50));
